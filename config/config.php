...
if (!defined('APP_NAME')) {
    define('APP_NAME', 'PinkClub Dojin');
}
if (!defined('BASE_URL')) {
...
return [
    'db' => $dbConfig,
    'security' => [
        'session_name' => 'pinkclub_dojin_session',
    ],
    'dmm' => [
        ...
        'master_floor_id' => '43',
        'catalog_targets' => [
            ['site' => 'FANZA', 'service' => 'doujin', 'floor' => 'doujin', 'label' => '同人'],
            ['site' => 'FANZA', 'service' => 'doujin', 'floor' => 'bl', 'label' => 'らぶカルBL'],
            ['site' => 'FANZA', 'service' => 'doujin', 'floor' => 'tl', 'label' => 'らぶカルTL'],
        ],
    ],
    'pagination' => [
        'per_page' => 32,
